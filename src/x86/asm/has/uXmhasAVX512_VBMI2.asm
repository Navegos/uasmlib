	...
	.code
			align 16
uXm_has_AVX512_VBMI2 proto VECCALL (byte)


			align 16
uXm_has_AVX512_VBMI2 proc VECCALL (byte)
			...
			cmp				ecx,			bit_AVX512_VBMI2			; AVX512_VBMI2 support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
