	...
	.code
			align 16
uXm_has_AVX512BW_VPCLMULQDQ proto VECCALL (byte)


			align 16
uXm_has_AVX512BW_VPCLMULQDQ proc VECCALL (byte)
			...
			mov				eax,			7
			cpuid
			and				ebx,			bit_AVX512F_BW
			cmp				ebx,			bit_AVX512F_BW				; AVX512F AVX512BW support by microprocessor
			jne not_supported
...
uXm_has_AVX512BW_VPCLMULQDQ endp
