	...
	.code
			align 16
uXm_has_AVX512_BITALG proto VECCALL (byte)


			align 16
uXm_has_AVX512_BITALG proc VECCALL (byte)
			...
			jne not_supported
			and				ecx,			bit_AVX512_BITALG
			cmp				ecx,			bit_AVX512_BITALG			; AVX512_BITALG support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
