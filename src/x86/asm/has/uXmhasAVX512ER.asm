	...
	.code
			align 16
uXm_has_AVX512ER proto VECCALL (byte)


			align 16
uXm_has_AVX512ER proc VECCALL (byte)
			...
			mov				eax,			7
			cpuid
			and				ebx,			bit_AVX512F_ER
			cmp				ebx,			bit_AVX512F_ER				; AVX512F AVX512ER support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
