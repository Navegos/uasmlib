	...
	.code
			align 16
uXm_has_AVX512_VPOPCNTDQ proto VECCALL (byte)


			align 16
uXm_has_AVX512_VPOPCNTDQ proc VECCALL (byte)
			...
			jne not_supported
			and				ecx,			bit_AVX512_VPOPCNTDQ
			cmp				ecx,			bit_AVX512_VPOPCNTDQ		; AVX512_VPOPCNTDQ support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
