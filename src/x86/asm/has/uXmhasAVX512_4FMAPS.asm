	...
	.code
			align 16
uXm_has_AVX512_4FMAPS proto VECCALL (byte)


			align 16
uXm_has_AVX512_4FMAPS proc VECCALL (byte)
			...
			jne not_supported
			and				edx,			bit_AVX512_4FMAPS
			cmp				edx,			bit_AVX512_4FMAPS			; AVX512_4FMAPS support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
