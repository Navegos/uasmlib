	...
	.code
			align 16
uXm_has_AVX512PF proto VECCALL (byte)


			align 16
uXm_has_AVX512PF proc VECCALL (byte)
			...
			mov				eax,			7
			cpuid
			and				ebx,			bit_AVX512F_PF
			cmp				ebx,			bit_AVX512F_PF				; AVX512F AVX512PF support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
