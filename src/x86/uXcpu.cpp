...
public:
	...
	uX_PACK_SIZE_T
		...
		63  or above = AVX512VL
		*/
		uX_constexpr count_t const uX_ABI IntrinSet(void) const
	{
		return _uX_CPUFeatures_IntrinSet();
	}

/* EFLAGS %eax=00H, %ebx=00H */
	uX_constexpr bool_t const uX_ABI has_CPUID(void) const
	{
		return _uX_CPUFeatures_has_CPUID();
	}

/* %eax=00H, %ecx */
	uX_constexpr bool_t const uX_ABI is_Intel(void) const
	{
		return _uX_CPUFeatures_is_Intel();
	}
	uX_constexpr bool_t const uX_ABI is_AMD(void) const
	{
		return _uX_CPUFeatures_is_AMD();
	}

/* %eax=01H, %ecx */
	uX_constexpr bool_t const uX_ABI has_SSE3(void) const
	{
		return _uX_CPUFeatures_has_SSE3();
	}
	uX_constexpr bool_t const uX_ABI has_PCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_PCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_MONITOR(void) const
	{
		return _uX_CPUFeatures_has_MONITOR();
	}
	uX_constexpr bool_t const uX_ABI has_SSSE3(void) const
	{
		return _uX_CPUFeatures_has_SSSE3();
	}
	uX_constexpr bool_t const uX_ABI has_FMA(void) const
	{
		return _uX_CPUFeatures_has_FMA();
	}
	uX_constexpr bool_t const uX_ABI has_CMPXCHG16B(void) const
	{
		return _uX_CPUFeatures_has_CMPXCHG16B();
	}
	uX_constexpr bool_t const uX_ABI has_SSE41(void) const
	{
		return _uX_CPUFeatures_has_SSE41();
	}
	uX_constexpr bool_t const uX_ABI has_SSE42(void) const
	{
		return _uX_CPUFeatures_has_SSE42();
	}
	uX_constexpr bool_t const uX_ABI has_MOVBE(void) const
	{
		return _uX_CPUFeatures_has_MOVBE();
	}
	uX_constexpr bool_t const uX_ABI has_POPCNT(void) const
	{
		return _uX_CPUFeatures_has_POPCNT();
	}
	uX_constexpr bool_t const uX_ABI has_AES(void) const
	{
		return _uX_CPUFeatures_has_AES();
	}
	uX_constexpr bool_t const uX_ABI has_XSAVE(void) const
	{
		return _uX_CPUFeatures_has_XSAVE();
	}
	uX_constexpr bool_t const uX_ABI has_OSXSAVE(void) const
	{
		return _uX_CPUFeatures_has_OSXSAVE();
	}
	uX_constexpr bool_t const uX_ABI has_AVX(void) const
	{
		return _uX_CPUFeatures_has_AVX();
	}
	uX_constexpr bool_t const uX_ABI has_F16C(void) const
	{
		return _uX_CPUFeatures_has_F16C();
	}
	uX_constexpr bool_t const uX_ABI has_RDRAND(void) const
	{
		return _uX_CPUFeatures_has_RDRAND();
	}

/* %eax=01H, %edx */
	uX_constexpr bool_t const uX_ABI has_FPU(void) const
	{
		return _uX_CPUFeatures_has_FPU();
	}
	uX_constexpr bool_t const uX_ABI has_TSC(void) const
	{
		return _uX_CPUFeatures_has_TSC();
	}
	uX_constexpr bool_t const uX_ABI has_MSR(void) const
	{
		return _uX_CPUFeatures_has_MSR();
	}
	uX_constexpr bool_t const uX_ABI has_CMPXCHG8B(void) const
	{
		return _uX_CPUFeatures_has_CMPXCHG8B();
	}
	uX_constexpr bool_t const uX_ABI has_SEP(void) const
	{
		return _uX_CPUFeatures_has_SEP();
	}
	uX_constexpr bool_t const uX_ABI has_CMOV(void) const
	{
		return _uX_CPUFeatures_has_CMOV();
	}
	uX_constexpr bool_t const uX_ABI has_CLFSH(void) const
	{
		return _uX_CPUFeatures_has_CLFSH();
	}
	uX_constexpr bool_t const uX_ABI has_MMX(void) const
	{
		return _uX_CPUFeatures_has_MMX();
	}
	uX_constexpr bool_t const uX_ABI has_FXSR(void) const
	{
		return _uX_CPUFeatures_has_FXSR();
	}
	uX_constexpr bool_t const uX_ABI has_SSE(void) const
	{
		return _uX_CPUFeatures_has_SSE();
	}
	uX_constexpr bool_t const uX_ABI has_SSE2(void) const
	{
		return _uX_CPUFeatures_has_SSE2();
	}

/* %eax=07H, %ebx */
	uX_constexpr bool_t const uX_ABI has_FSGSBASE(void) const
	{
		return _uX_CPUFeatures_has_FSGSBASE();
	}
	uX_constexpr bool_t const uX_ABI has_SGX(void) const
	{
		return _uX_CPUFeatures_has_SGX();
	}
	uX_constexpr bool_t const uX_ABI has_BMI1(void) const
	{
		return _uX_CPUFeatures_has_BMI1();
	}
	uX_constexpr bool_t const uX_ABI has_HLE(void) const
	{
		return _uX_CPUFeatures_has_HLE();
	}
	uX_constexpr bool_t const uX_ABI has_AVX2(void) const
	{
		return _uX_CPUFeatures_has_AVX2();
	}
	uX_constexpr bool_t const uX_ABI has_SMEP(void) const
	{
		return _uX_CPUFeatures_has_SMEP();
	}
	uX_constexpr bool_t const uX_ABI has_BMI2(void) const
	{
		return _uX_CPUFeatures_has_BMI2();
	}
	uX_constexpr bool_t const uX_ABI has_ERMS(void) const
	{
		return _uX_CPUFeatures_has_ERMS();
	}
	uX_constexpr bool_t const uX_ABI has_INVPCID(void) const
	{
		return _uX_CPUFeatures_has_INVPCID();
	}
	uX_constexpr bool_t const uX_ABI has_RTM(void) const
	{
		return _uX_CPUFeatures_has_RTM();
	}
	uX_constexpr bool_t const uX_ABI has_MPX(void) const
	{
		return _uX_CPUFeatures_has_MPX();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512F(void) const
	{
		return _uX_CPUFeatures_has_AVX512F();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512DQ(void) const
	{
		return _uX_CPUFeatures_has_AVX512DQ();
	}
	uX_constexpr bool_t const uX_ABI has_RDSEED(void) const
	{
		return _uX_CPUFeatures_has_RDSEED();
	}
	uX_constexpr bool_t const uX_ABI has_ADX(void) const
	{
		return _uX_CPUFeatures_has_ADX();
	}
	uX_constexpr bool_t const uX_ABI has_SMAP(void) const
	{
		return _uX_CPUFeatures_has_SMAP();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_IFMA(void) const
	{
		return _uX_CPUFeatures_has_AVX512_IFMA();
	}
	uX_constexpr bool_t const uX_ABI has_CLFLUSHOPT(void) const
	{
		return _uX_CPUFeatures_has_CLFLUSHOPT();
	}
	uX_constexpr bool_t const uX_ABI has_CLWB(void) const
	{
		return _uX_CPUFeatures_has_CLWB();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512PF(void) const
	{
		return _uX_CPUFeatures_has_AVX512PF();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512ER(void) const
	{
		return _uX_CPUFeatures_has_AVX512ER();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512CD(void) const
	{
		return _uX_CPUFeatures_has_AVX512CD();
	}
	uX_constexpr bool_t const uX_ABI has_SHA(void) const
	{
		return _uX_CPUFeatures_has_SHA();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512BW(void) const
	{
		return _uX_CPUFeatures_has_AVX512BW();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512VL();
	}

/* %eax=07H, %ecx */
	uX_constexpr bool_t const uX_ABI has_PREFETCHWT1(void) const
	{
		return _uX_CPUFeatures_has_PREFETCHWT1();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VBMI(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VBMI();
	}
	uX_constexpr bool_t const uX_ABI has_UMIP(void) const
	{
		return _uX_CPUFeatures_has_UMIP();
	}
	uX_constexpr bool_t const uX_ABI has_PKU(void) const
	{
		return _uX_CPUFeatures_has_PKU();
	}
	uX_constexpr bool_t const uX_ABI has_OSPKE(void) const
	{
		return _uX_CPUFeatures_has_OSPKE();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VBMI2(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VBMI2();
	}
	uX_constexpr bool_t const uX_ABI has_GFNI(void) const
	{
		return _uX_CPUFeatures_has_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_VAES(void) const
	{
		return _uX_CPUFeatures_has_VAES();
	}
	uX_constexpr bool_t const uX_ABI has_VPCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_VPCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VNNI(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VNNI();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_BITALG(void) const
	{
		return _uX_CPUFeatures_has_AVX512_BITALG();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VPOPCNTDQ(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VPOPCNTDQ();
	}
	uX_constexpr bool_t const uX_ABI has_RDPID(void) const
	{
		return _uX_CPUFeatures_has_RDPID();
	}

/* %eax=07H, %edx */
	uX_constexpr bool_t const uX_ABI has_AVX512_4VNNIW(void) const
	{
		return _uX_CPUFeatures_has_AVX512_4VNNIW();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_4FMAPS(void) const
	{
		return _uX_CPUFeatures_has_AVX512_4FMAPS();
	}

/* %eax=80000001H, %ecx */
	uX_constexpr bool_t const uX_ABI has_LAHF(void) const
	{
		return _uX_CPUFeatures_has_LAHF();
	}
	uX_constexpr bool_t const uX_ABI has_LZCNT(void) const
	{
		return _uX_CPUFeatures_has_LZCNT();
	}
	uX_constexpr bool_t const uX_ABI has_ABM(void) const
	{
		return _uX_CPUFeatures_has_ABM();
	}
	uX_constexpr bool_t const uX_ABI has_SSE4a(void) const
	{
		return _uX_CPUFeatures_has_SSE4a();
	}
	uX_constexpr bool_t const uX_ABI has_PREFETCHW(void) const
	{
		return _uX_CPUFeatures_has_PREFETCHW();
	}
	uX_constexpr bool_t const uX_ABI has_XOP(void) const
	{
		return _uX_CPUFeatures_has_XOP();
	}
	uX_constexpr bool_t const uX_ABI has_LWP(void) const
	{
		return _uX_CPUFeatures_has_LWP();
	}
	uX_constexpr bool_t const uX_ABI has_FMA4(void) const
	{
		return _uX_CPUFeatures_has_FMA4();
	}
	uX_constexpr bool_t const uX_ABI has_TBM(void) const
	{
		return _uX_CPUFeatures_has_TBM();
	}
	uX_constexpr bool_t const uX_ABI has_MWAITX(void) const
	{
		return _uX_CPUFeatures_has_MWAITX();
	}

/* %eax=80000001H, %edx */
	uX_constexpr bool_t const uX_ABI has_SYSCALL(void) const
	{
		return _uX_CPUFeatures_has_SYSCALL();
	}
	uX_constexpr bool_t const uX_ABI has_MMXEXT(void) const
	{
		return _uX_CPUFeatures_has_MMXEXT();
	}
	uX_constexpr bool_t const uX_ABI has_RDTSCP(void) const
	{
		return _uX_CPUFeatures_has_RDTSCP();
	}
	uX_constexpr bool_t const uX_ABI has_3DNOWEXT(void) const
	{
		return _uX_CPUFeatures_has_3DNOWEXT();
	}
	uX_constexpr bool_t const uX_ABI has_3DNOW(void) const
	{
		return _uX_CPUFeatures_has_3DNOW();
	}

/* %eax=07H, %ebx, %ecx */
	uX_constexpr bool_t const uX_ABI has_AVX512_GFNI(void) const
	{
		return _uX_CPUFeatures_has_AVX512_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_GFNI_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512_GFNI_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VAES(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VAES();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VAES_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VAES_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VPCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VPCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VPCLMULQDQ_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VPCLMULQDQ_VL();
	}

	uX_constexpr bool_t const uX_ABI has_AVX512_IFMA_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512_IFMA_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VBMI_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VBMI_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VBMI2_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VBMI2_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VNNI_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VNNI_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_BITALG_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512_BITALG_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512_VPOPCNTDQ_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512_VPOPCNTDQ_VL();
	}

	uX_constexpr bool_t const uX_ABI has_AVX512BW_GFNI(void) const
	{
		return _uX_CPUFeatures_has_AVX512BW_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512BW_GFNI_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512BW_GFNI_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512BW_VAES(void) const
	{
		return _uX_CPUFeatures_has_AVX512BW_VAES();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512BW_VAES_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512BW_VAES_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512BW_VPCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_AVX512BW_VPCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512BW_VPCLMULQDQ_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512BW_VPCLMULQDQ_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512BW_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512BW_VL();
	}

	uX_constexpr bool_t const uX_ABI has_AVX512DQ_GFNI(void) const
	{
		return _uX_CPUFeatures_has_AVX512DQ_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512DQ_GFNI_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512DQ_GFNI_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512DQ_VAES(void) const
	{
		return _uX_CPUFeatures_has_AVX512DQ_VAES();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512DQ_VAES_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512DQ_VAES_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512DQ_VPCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_AVX512DQ_VPCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512DQ_VPCLMULQDQ_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512DQ_VPCLMULQDQ_VL();
	}
	uX_constexpr bool_t const uX_ABI has_AVX512DQ_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512DQ_VL();
	}

	uX_constexpr bool_t const uX_ABI has_AVX512CD_VL(void) const
	{
		return _uX_CPUFeatures_has_AVX512CD_VL();
	}

/* %eax=07H, %ecx, %ebx | %eax=01H, %ecx , %edx */
	uX_constexpr bool_t const uX_ABI has_SSE_AES(void) const
	{
		return _uX_CPUFeatures_has_SSE_AES();
	}
	uX_constexpr bool_t const uX_ABI has_SSE_GFNI(void) const
	{
		return _uX_CPUFeatures_has_SSE_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_SSE_PCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_SSE_PCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_SSE2_AES(void) const
	{
		return _uX_CPUFeatures_has_SSE2_AES();
	}
	uX_constexpr bool_t const uX_ABI has_SSE2_GFNI(void) const
	{
		return _uX_CPUFeatures_has_SSE2_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_SSE2_PCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_SSE2_PCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_SSE3_AES(void) const
	{
		return _uX_CPUFeatures_has_SSE3_AES();
	}
	uX_constexpr bool_t const uX_ABI has_SSE3_GFNI(void) const
	{
		return _uX_CPUFeatures_has_SSE3_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_SSE3_PCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_SSE3_PCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_SSSE3_AES(void) const
	{
		return _uX_CPUFeatures_has_SSSE3_AES();
	}
	uX_constexpr bool_t const uX_ABI has_SSSE3_GFNI(void) const
	{
		return _uX_CPUFeatures_has_SSSE3_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_SSSE3_PCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_SSSE3_PCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_SSE41_AES(void) const
	{
		return _uX_CPUFeatures_has_SSE41_AES();
	}
	uX_constexpr bool_t const uX_ABI has_SSE41_GFNI(void) const
	{
		return _uX_CPUFeatures_has_SSE41_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_SSE41_PCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_SSE41_PCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_SSE42_AES(void) const
	{
		return _uX_CPUFeatures_has_SSE42_AES();
	}
	uX_constexpr bool_t const uX_ABI has_SSE42_GFNI(void) const
	{
		return _uX_CPUFeatures_has_SSE42_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_SSE42_PCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_SSE42_PCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_AVX_AES(void) const
	{
		return _uX_CPUFeatures_has_AVX_AES();
	}
	uX_constexpr bool_t const uX_ABI has_AVX_GFNI(void) const
	{
		return _uX_CPUFeatures_has_AVX_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_AVX_PCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_AVX_PCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_AVX_VAES(void) const
	{
		return _uX_CPUFeatures_has_AVX_VAES();
	}
	uX_constexpr bool_t const uX_ABI has_AVX_VPCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_AVX_VPCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_AVX2_AES(void) const
	{
		return _uX_CPUFeatures_has_AVX2_AES();
	}
	uX_constexpr bool_t const uX_ABI has_AVX2_GFNI(void) const
	{
		return _uX_CPUFeatures_has_AVX2_GFNI();
	}
	uX_constexpr bool_t const uX_ABI has_AVX2_PCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_AVX2_PCLMULQDQ();
	}
	uX_constexpr bool_t const uX_ABI has_AVX2_VAES(void) const
	{
		return _uX_CPUFeatures_has_AVX2_VAES();
	}
	uX_constexpr bool_t const uX_ABI has_AVX2_VPCLMULQDQ(void) const
	{
		return _uX_CPUFeatures_has_AVX2_VPCLMULQDQ();
	}

	uX_constexpr bool_t const uX_ABI has_enabled_XMM(void) const
	{
		return _uX_CPUFeatures_has_enabled_XMM();
	}
	uX_constexpr bool_t const uX_ABI has_enabled_YMM(void) const
	{
		return _uX_CPUFeatures_has_enabled_YMM();
	}
	uX_constexpr bool_t const uX_ABI has_enabled_ZMM(void) const
	{
		return _uX_CPUFeatures_has_enabled_ZMM();
	}

/* Check if CPUFeatures is initiated */
	uX_constexpr bool_t const uX_ABI is_Inited(void) const
	{
		return _uX_CPUFeatures_is_Inited();
	}
	...
	uX_PACK_STACK
		...
		uX_constexpr void const uX_ABI CpuType(int* vendor, int* family, int* model) const
	{
		_uX_CPUFeatures_CpuType(vendor, family, model);
	}

	uX_constexpr char const* const uX_ABI ProcessorName(void) const
	{
		return _uX_CPUFeatures_ProcessorName();
	}
	...
	uX_PACK_SIZE_T
		...
		uX_constexpr size_t const uX_ABI DataCacheSize(int level) const
	{
		return _uX_CPUFeatures_DataCacheSize(level);
	}
	uX_constexpr size_t const uX_ABI L1DataCacheSize(void) const
	{
		return _uX_CPUFeatures_L1DataCacheSize();
	}
	uX_constexpr size_t const uX_ABI L2DataCacheSize(void) const
	{
		return _uX_CPUFeatures_L2DataCacheSize();
	}
	uX_constexpr size_t const uX_ABI L3DataCacheSize(void) const
	{
		return _uX_CPUFeatures_L3DataCacheSize();
	}

	uX_constexpr count_t const uX_ABI UnalignedIsFaster(void) const
	{
		return _uX_CPUFeatures_UnalignedIsFaster();
	}
	uX_constexpr count_t const uX_ABI Store256BitIsFaster(void) const
	{
		return _uX_CPUFeatures_Store256BitIsFaster();
	}
} CPUFeatures_t;
