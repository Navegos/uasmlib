...
{
    return vecfloat2(_uX_MM_PERMUTER_IM_PS(m128_xmm, 0, 2, 1, 3));
}
...
{
    return vecfloat2(_uX_MM_PERMUTER_IM_PS(m128_xmm, 1, 2, 0, 3));
}
...
{
    return vecfloat2(_uX_MM_PERMUTER_IM_PS(m128_xmm, 2, 0, 1, 3));
}
...
{
    return vecfloat2(_uX_MM_PERMUTER_IM_PS(m128_xmm, 2, 1, 0, 3));
}
