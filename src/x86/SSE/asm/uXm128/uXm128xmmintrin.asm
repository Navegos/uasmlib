	...
	ifndef __X64__
		...
		m128cvteltsf32jmptable isize_t offset m128cvteltsf32_0, offset m128cvteltsf32_1, offset m128cvteltsf32_2, offset m128cvteltsf32_3			
		m128prefetchjmptable isize_t offset m128prefetch_0, offset m128prefetch_1, offset m128prefetch_2, offset m128prefetch_3
...
_uXm_m128_cvt0s_f32 proto UX_VECCALL (real4) ;InXmm_A:xmmword
_uXm_m128_cvt1s_f32 proto UX_VECCALL (real4) ;InXmm_A:xmmword
_uXm_m128_cvt2s_f32 proto UX_VECCALL (real4) ;InXmm_A:xmmword
_uXm_m128_cvt3s_f32 proto UX_VECCALL (real4) ;InXmm_A:xmmword
_uXm_m128_cvtelts_f32 proto UX_VECCALL (real4) ;InXmm_A:xmmword, InInt_BSel:dword

ifdef __X32__
_uXm_m128_cvt_ps2pi proto UX_VECCALL (mmword) ;InXmm_A:xmmword
_uXm_m128_cvtt_ps2pi proto UX_VECCALL (mmword) ;InXmm_A:xmmword
...
_uXm_m128_cvt0s_f32 proc UX_VECCALL (real4) ;InXmm_A:xmmword
			
			movss			xmm0,			xmm0

			ret
_uXm_m128_cvt0s_f32 endp

_uXm_m128_cvt1s_f32 proc UX_VECCALL (real4) ;InXmm_A:xmmword

			shufps			xmm0,			xmm0,			_uXm_mm_shuffler4(1,1,1,1)
			movss			xmm0,			xmm0

			ret
_uXm_m128_cvt1s_f32 endp

_uXm_m128_cvt2s_f32 proc UX_VECCALL (real4) ;InXmm_A:xmmword

			shufps			xmm0,			xmm0,			_uXm_mm_shuffler4(2,2,2,2)
			movss			xmm0,			xmm0

			ret
_uXm_m128_cvt2s_f32 endp

_uXm_m128_cvt3s_f32 proc UX_VECCALL (real4) ;InXmm_A:xmmword

			shufps			xmm0,			xmm0,			_uXm_mm_shuffler4(3,3,3,3)
			movss			xmm0,			xmm0

			ret
_uXm_m128_cvt3s_f32 endp
...
_uXm_m128_cvtelts_f32 proc UX_VECCALL (real4) ;InXmm_A:xmmword, InInt_BSel:dword
		...
		m128cvteltsf32_0 label size_t
			movss			xmm0,			xmm0
			ret
		m128cvteltsf32_1 label size_t
			shufps			xmm0,			xmm0,			_uXm_mm_shuffler4(1,1,1,1)
			movss			xmm0,			xmm0
			ret
		m128cvteltsf32_2 label size_t
			shufps			xmm0,			xmm0,			_uXm_mm_shuffler4(2,2,2,2)
			movss			xmm0,			xmm0
			ret
		m128cvteltsf32_3 label size_t
			shufps			xmm0,			xmm0,			_uXm_mm_shuffler4(3,3,3,3)
			movss			xmm0,			xmm0
			ret
		;.endif
...
ifdef __X32__
_uXm_m128_cvt_ps2pi proc UX_VECCALL (mmword) ;InXmm_A:xmmword
			
			cvtps2pi			mm0,			xmm0

			ret
_uXm_m128_cvt_ps2pi endp

_uXm_m128_cvtt_ps2pi proc UX_VECCALL (mmword) ;InXmm_A:xmmword
			
			cvttps2pi			mm0,			xmm0

			ret
_uXm_m128_cvtt_ps2pi endp
...
_uXm_m128_prefetch proc UX_VECCALL (voidarg) ;InPInt8_A:ptr byte, InInt_BSel:dword
		...
		ifndef __X64__
			movzx			eax,	byte ptr [rparam2]
			;mov				rbx,	dword ptr [rbx+rparam2*4]
			jmp		dword ptr [m128prefetchjmptable+eax*4]
		else
			;movzx			rax,	byte ptr [rparam2]
			lea				rbx,	qword ptr [m128prefetchjmptable]
			mov				rbx,	qword ptr [rbx+rparam2*8]
			jmp				rbx
		endif
			
		m128prefetch_0 label size_t
			prefetchnta			byte ptr [rparam1]
			ret
		m128prefetch_1 label size_t
			prefetcht0			byte ptr [rparam1]
			ret
		m128prefetch_2 label size_t
			prefetcht1			byte ptr [rparam1]
			ret
		m128prefetch_3 label size_t
			prefetcht2			byte ptr [rparam1]
			ret
		;.endif
