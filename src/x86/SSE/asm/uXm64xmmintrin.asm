...
_uXm_m64_cvt_pi2ps proto UX_VECCALL (xmmword) ;InXmm_A:xmmword, Inmm_B:mmword
endif ;!__X32__
...
_uXm_m64_cvtt_ps2pi endp
			...
			align 16
_uXm_m64_cvt_pi2ps proc UX_VECCALL (xmmword) ;InXmm_A:xmmword, Inmm_B:mmword
			
			cvtpi2ps			xmm0,			mm1

			ret
_uXm_m64_cvt_pi2ps endp
endif ;__X32__
