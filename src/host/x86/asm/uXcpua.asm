...
.data
    ...
    v1ci __uX_CPUFeatures_UnalignedIsFaster,            dd, 0
    v1ci __uX_CPUFeatures_Store256BitIsFaster,          dd, 0

    v1ci __uX_CPUFeatures_DataCacheSize,                isize_t, 0
    v1ci __uX_CPUFeatures_L1DataCacheSize,              isize_t, 0
    v1ci __uX_CPUFeatures_L2DataCacheSize,              isize_t, 0
    v1ci __uX_CPUFeatures_L3DataCacheSize,              isize_t, 0
...
procstart _uX_CPUFeatures_Init, callconv, void, < >, < >, infolevel:dword
    ...
    CPUInitNoID:
            ...
            mov     dword ptr [__uX_CPUFeatures_ProcessorName],     edi            ; Pointer to result
            pop                 edi
            .endif
            pop                 ebx
            jmp                 CPUInitEND
    ...
    bvendor:
            .if (__uX_CPUFeatures_infolevel >= 1) ;__uX_CPUFeatures_infolevel >= 1
    ...
    ifdef __x64__
                ...
                mov     __uX_CPUFeatures_family,            dfamily
                mov     __uX_CPUFeatures_model,             dmodel

    ifdef __x32__
                xor                 rdest,                  rdest
                mov                 rdest,  dword ptr [__uX_CPUFeatures_ProcessorName]        ; Pointer to result
    endif
    ifdef __x64__
                xor                 rdest,                  rdest
    ...
    ifdef __x32__
                ...
                mov     dword ptr [__uX_CPUFeatures_ProcessorName],     rdest      ; Pointer to result
    endif
    ...
    ifdef __x64__
                ...
                mov                 eax,                    __uX_CPUFeatures_vendor
                dec                 eax
                jz                  Intel
                dec                 eax
                jz                  AMD
        ...
        ; unknown vendor, try all methods
            ...
            fordatacachesize:
                ...
                .if (dnumlevel == 3)
                    ...
                    mov     __uX_CPUFeatures_L3DataCacheSize,   rret()
                .elseif (dnumlevel == 2)
                    mov                 rret(),                 [rlevel+rnumlevel*reg_size]
                    mov     __uX_CPUFeatures_L2DataCacheSize,   rret()
                .elseif (dnumlevel == 1)
                    mov                 rret(),                 [rlevel+rnumlevel*reg_size]
                    mov     __uX_CPUFeatures_L1DataCacheSize,   rret()
            ...
            D850:
                ...
                ;mov     __uX_CPUFeatures_DataCacheSize,     rret()
            ;D900:
            .endif ;__uX_CPUFeatures_infolevel >= 1
    ...
    ifdef __x32__
            ...
            .endif
        .endif ;__uX_CPUFeatures_ntel == true
...
sse_not_supported:
        ...
        .if (__uX_CPUFeatures_infolevel >= 2) ;__uX_CPUFeatures_infolevel >= 2
                mov             dvendor,            __uX_CPUFeatures_vendor
                mov             dfamily,            __uX_CPUFeatures_family
                mov             dmodel,             __uX_CPUFeatures_model
            ...
            UVIA:           ; Unaligned read is not faster than PALIGNR on VIA Nano 2000 and 3000                
                ...
                ;jmp             Uend
                mov     __uX_CPUFeatures_UnalignedIsFaster,         eax

            Uend:
                xor             eax,                eax
                .if (__uX_CPUFeatures_AVX == true)
            ...
            S92:
                mov             eax,                2                   ; return 2
            Send:
                mov     __uX_CPUFeatures_Store256BitIsFaster,      eax
            .endif ;__uX_CPUFeatures_AVX == true

        .endif ;__uX_CPUFeatures_infolevel >= 2
...
procstart _uX_CPUFeatures_Fin, callconv, void, < >, < >, < >
            ...
            mov     __uX_CPUFeatures_Store256BitIsFaster,   dret()
            mov     __uX_CPUFeatures_UnalignedIsFaster,     dret()
...
procstart _uX_CPUFeatures_ProcessorName, callconv, ptr, < >, < >, < >
    ifdef __x32__
            mov             rret(),             dword ptr [__uX_CPUFeatures_ProcessorName]        ; Pointer to result
    endif
    ifdef __x64__
...
procstart _uX_CPUFeatures_DataCacheSize, callconv, size_t, < >, < >, level:dword
            xor             rret(),             rret()
            .if (dchlevel == 3)
                    mov                 rret(),             __uX_CPUFeatures_L3DataCacheSize        ; Pointer to result
            .elseif (dchlevel == 2)
                    mov                 rret(),             __uX_CPUFeatures_L2DataCacheSize        ; Pointer to result
            .elseif (dchlevel == 1)
                    mov                 rret(),             __uX_CPUFeatures_L1DataCacheSize        ; Pointer to result
            .elseif (dchlevel == 0)
...
procstart _uX_CPUFeatures_UnalignedIsFaster, callconv, dword, < >, < >, < >
            mov                 dret(),             __uX_CPUFeatures_UnalignedIsFaster
            ret
procend

procstart _uX_CPUFeatures_Store256BitIsFaster, callconv, dword, < >, < >, < >
            mov                 dret(),             __uX_CPUFeatures_Store256BitIsFaster
            ret
procend
...
procstart _uX_CPUFeatures_has_CPUID, callconv, dword, < >, < >, < >
        mov             dret(),             __uX_CPUFeatures_CPUID
        ret
procend
