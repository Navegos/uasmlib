	...
	.code
			align 16
uXm_has_AVX512DQ_VPCLMULQDQ proto VECCALL (byte)


			align 16
uXm_has_AVX512DQ_VPCLMULQDQ proc VECCALL (byte)
			...
			mov				eax,			7
			cpuid
			and				ebx,			bit_AVX512F_DQ
			cmp				ebx,			bit_AVX512F_DQ				; AVX512F AVX512DQ support by microprocessor
			jne not_supported
...
uXm_has_AVX512DQ_VPCLMULQDQ endp
