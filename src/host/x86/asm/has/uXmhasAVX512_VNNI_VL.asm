	...
	.code
			align 16
uXm_has_AVX512_VNNI_VL proto VECCALL (byte)


			align 16
uXm_has_AVX512_VNNI_VL proc VECCALL (byte)
			...
			jne not_supported
			and				ecx,			bit_AVX512_VNNI
			cmp				ecx,			bit_AVX512_VNNI				; AVX512_VNNI support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
