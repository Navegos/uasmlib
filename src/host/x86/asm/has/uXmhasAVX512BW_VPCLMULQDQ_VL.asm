	...
	.code
			align 16
uXm_has_AVX512BW_VPCLMULQDQ_VL proto VECCALL (byte)


			align 16
uXm_has_AVX512BW_VPCLMULQDQ_VL proc VECCALL (byte)
			...
			mov				eax,			7
			cpuid
			and				ebx,			bit_AVX512F_BW_VL
			cmp				ebx,			bit_AVX512F_BW_VL			; AVX512F AVX512BW AVX512VL support by microprocessor
			jne not_supported
...
uXm_has_AVX512BW_VPCLMULQDQ_VL endp
