	...
	.code
			align 16
uXm_has_AVX512_4VNNIW proto VECCALL (byte)


			align 16
uXm_has_AVX512_4VNNIW proc VECCALL (byte)
			...
			jne not_supported
			and				edx,			bit_AVX512_4VNNIW
			cmp				edx,			bit_AVX512_4VNNIW			; AVX512_4VNNIW support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
