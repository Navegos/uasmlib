	...
	.code
			align 16
uXm_has_AVX512CD_VL proto VECCALL (byte)


			align 16
uXm_has_AVX512CD_VL proc VECCALL (byte)
			...
			mov				eax,			7
			cpuid
			and				ebx,			bit_AVX512F_CD_VL
			cmp				ebx,			bit_AVX512F_CD_VL			; AVX512F AVX512CD AVX512VL support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
