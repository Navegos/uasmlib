	...
	.code
			align 16
uXm_has_AVX512_IFMA proto VECCALL (byte)


			align 16
uXm_has_AVX512_IFMA proc VECCALL (byte)
			...
			mov				eax,			7
			cpuid
			and				ebx,			bit_AVX512F_IFMA
			cmp				ebx,			bit_AVX512F_IFMA			; AVX512F AVX512_IFMA support by microprocessor
			jne not_supported
			mov				al,				true
			jmp done
			not_supported:
