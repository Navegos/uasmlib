...
# endif
#		define uX_CLANG 1
#		define uX_CLANG_COMPILER 1	/* CLANG Compiler */
...
#	endif
#		define uX_GCC 1
#		define uX_GCC_COMPILER 1	/* GCC Compiler */
# endif
# if	defined(__SNC__)
#		define uX_SNC 1
# endif
...
#		define uX_ARCH_MIPS64 1
#		define uX_MIPS64_ABI 1
#	else
#		define uX_ARCH_MIPS32 1
...
#		define uX_WINDOWS_OS 1
# endif*/
#elif defined(__APPLE_CC__) && (defined(__apple__) || defined(__APPLE__) || defined(__MACH__) || defined(TARGET_OS_MAC))
...
#			define uX_APPLE_FAMILY 1
#		endif
#	elif ((defined(__apple__) || defined(__APPLE__)) && defined(__MACH__)) || defined(TARGET_OS_MAC)
#			define uX_OSX 1
#			define uX_OSX_OS 1
#			define uX_DARWIN_OS 1
...
#	endif
				...
				|| defined(__FreeBSD__) || defined(__freebsd__) || defined(__NetBSD__) || defined(__netbsd__) || defined(__OpenBSD__) || defined(__openbsd__) || defined(__bsdi__) \
				|| defined(__DragonFly__) || defined(__bg__) || defined(__CYGWIN__) || defined(ANDROID_NDK) || defined(ANDROID) || defined(NDK) || defined(__ANDROID_API__) || defined(__ANDROID__) || defined(__ELF__))
#		define uX_UNIX 1
#		define uX_UNIX_FAMILY 1
#		define uX_ELF 1
...
#	elif defined(__linux__) || defined(__linux) || defined(linux) || defined(unix) || defined(__unix__) || defined(__unix) || defined(__ORBIS__) \
				|| defined(__FreeBSD__) || defined(__freebsd__) || defined(__NetBSD__) || defined(__netbsd__) || defined(__OpenBSD__) || defined(__openbsd__) || defined(__bsdi__) \|| defined(__DragonFly__) || defined(__bg__)
#	if defined(__ORBIS__) || defined(__FreeBSD__) || defined(__freebsd__) || defined(__NetBSD__) || defined(__netbsd__) || defined(__OpenBSD__) || defined(__openbsd__) || defined(__bsdi__) || defined(__DragonFly__)
#		define uX_BSD_OS 1
#		if defined(__FreeBSD__) || defined(__freebsd__)
#			define uX_FREEBSD_OS 1
#		endif
#		if defined(__NetBSD__) || defined(__netbsd__)
#			define uX_NETBSD_OS 1
#		endif
#		if defined(__ORBIS__)
#			define uX_PS4_OS 1
#		endif
...
#		define uX_LINUX 1
#		define uX_LINUX_OS 1
#	elif defined(__gnu_linux__)
#		define uX_LINUX 1
#		define uX_GNU_LINUX_OS 1
#		define uX_LINUX_OS 1
#	elif defined(__bg__)
#		define uX_LINUX 1
#		define uX_CNK_LINUX_OS 1
...
#		define uX_ARCH_X86_OR_X64 1			/* x86 or x64 cpu*/
...
#		define uX_ARCH_A32_OR_A64 1			/* ARM 32bits or 64bits cpu */
...
#		define uX_ARCH_PPC32_OR_PPC64 1			/* PPC 32bits or 64bits cpu */
#endif
...
#define ARM_INTRIN 1
#endif
#ifndef ARM_NEON_INTRIN
#define ARM_NEON_INTRIN 1
#endif
#elif defined(uX_MIC)
#ifndef INTRIN_MIC
#define INTRIN_MIC 1
#endif
#elif defined(uX_MIPS)
...
#	endif
#elif defined(uX_A32_OR_A64_CPU) && defined(uX_SUPPORTS_ARM_NEON) //Lets cross the fingers that MSVC support this!!! MSVC workaround
# if defined(uX_SUPPORTS_ARM_V6) || defined(uX_ARCH_ARM_V7) || defined(uX_ARCH_ARM_V8) || defined(uX_ARCH_ARM_V9)
#	ifndef uX_SUPPORTS_MISALIGNED_MEMORY_ACCESS
#		define uX_SUPPORTS_MISALIGNED_MEMORY_ACCESS 1
#	endif
#endif
...
#	endif
#	if defined(uX_ARCH_SUPPORTS_DOUBLE) && defined(uX_SUPPORTS_ARM_NEON_DFP)
#		ifndef uX_SUPPORTS_DOUBLE_PRECISION_FPU
#			define uX_SUPPORTS_DOUBLE_PRECISION_FPU 1
#		endif
#	endif
...
#		endif
#	endif
#	if defined(__AES__) && (defined(uX_SSE_INTRIN) || defined(uX_AVX256_INTRIN) || defined(uX_AVX512_INTRIN))
#		ifndef uX_SUPPORTS_AES
#			define uX_SUPPORTS_AES 1
#		endif
#	endif
...
#		endif
#	endif
#	endif /*uX_GCC_COMPATIBLE_COMPILER*/
