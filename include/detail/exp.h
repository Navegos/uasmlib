...
#ifdef BUILD_LIB
# define uX_BUILD_SOURCE 1
#endif

#if (defined(EXPORTS) || defined(_EXPORTS) || defined(LIB_EXPORTS)) && defined(uX_BUILD_SOURCE)
...
#if !defined(uX_LIB_EXPORTS) && !defined(uX_BUILD_SOURCE)
#ifndef uX_LIB_IMPORTS
...
#ifdef uX_BUILD_SOURCE
#	if defined(uX_LIB_DLL) && !defined(uX_LIB_STATIC)
#		define uX_SRCAPI
#	else 
#		define uX_SRCAPI uX_INLINE
#	endif
#endif
