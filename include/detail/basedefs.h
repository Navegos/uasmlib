...
#		define uX_inline	inline
#		define uX_ATRIBUTE_inline	__attribute__((__gnu_inline__, __always_inline__))
...
#		define uX_inline	inline
#		define uX_ATRIBUTE_inline	__attribute__((__always_inline__, __nodebug__))
// inline hallways on for inline only artificial
...
#		define uX_inline	inline
#		define uX_ATRIBUTE_inline	__attribute__((always_inline))
// inline hallways on for inline only artificial
...
#if defined(uX_CUDACC)
#	define uX_gen_cpu_gpu						__Cuda_host__ __Cuda_device__
#	define uX_gen_cpu_only						__Cuda_host__
#	define uX_gen_gpu_only						__Cuda_device__
#	define uX_gen_device_builtin				__Cuda_device_builtin__
#	define uX_gen_gpu_only_device_builtin		__Cuda_device__ __Cuda_device_builtin__
#	define uX_gen_cpu_gpu_device_builtin		__Cuda_host__ __Cuda_device__ __Cuda_device_builtin__
#elif defined(uX_INTELCC_GFX)
#	define uX_gen_cpu_gpu						__Intel_host__ __Intel_device__
#	define uX_gen_cpu_only						__Intel_host__
#	define uX_gen_gpu_only						__Intel_device__
#	define uX_gen_device_builtin				__Intel_device_builtin__
#	define uX_gen_gpu_only_device_builtin		__Intel_device__ __Intel_device_builtin__
#	define uX_gen_cpu_gpu_device_builtin		__Intel_host__ __Intel_device__ __Intel_device_builtin__
#else
#	define uX_gen_cpu_gpu
#	define uX_gen_cpu_only
#	define uX_gen_gpu_only
#	define uX_gen_device_builtin
#	define uX_gen_gpu_only_device_builtin
#	define uX_gen_cpu_gpu_device_builtin
#endif

#if defined(uX_CC_PDEF_GPU_SUPPORT)
#	define uX_gen_gpu_only_device_builtin_S_inline(T) uX_S_inline(uX_gen_gpu_only uX_gen_device_builtin T)
#	define uX_gen_gpu_only_device_builtin_S_finline(T) uX_S_finline(uX_gen_gpu_only uX_gen_device_builtin T)
#	define uX_gen_gpu_only_device_builtin_inline(T) uX_inline uX_gen_gpu_only uX_gen_device_builtin T
#	define uX_gen_gpu_only_device_builtin_finline(T) uX_finline(uX_gen_gpu_only uX_gen_device_builtin T)

#	define uX_gen_gpu_only_S_inline(T) uX_S_inline(uX_gen_gpu_only T)
#	define uX_gen_gpu_only_S_finline(T) uX_S_finline(uX_gen_gpu_only T)
#	define uX_gen_gpu_only_inline(T) uX_inline uX_gen_gpu_only T
#	define uX_gen_gpu_only_finline(T) uX_finline(uX_gen_gpu_only T)

#	define uX_gen_cpu_only_S_inline(T) uX_S_inline(uX_gen_cpu_only T)
#	define uX_gen_cpu_only_S_finline(T) uX_S_finline(uX_gen_cpu_only T)
#	define uX_gen_cpu_only_inline(T) uX_inline uX_gen_cpu_only T
#	define uX_gen_cpu_only_finline(T) uX_finline(uX_gen_cpu_only T)

#	define uX_gen_cpu_only_S_inline_veccall(T) uX_S_inline(uX_gen_cpu_only T)
#	define uX_gen_cpu_only_S_finline_veccall(T) uX_S_finline(uX_gen_cpu_only T)
#	define uX_gen_cpu_only_inline_veccall(T) uX_inline uX_gen_cpu_only T
#	define uX_gen_cpu_only_finline_veccall(T) uX_finline(uX_gen_cpu_only T)

#	define uX_gen_cpu_gpu_device_builtin_S_inline(T) uX_S_inline(uX_gen_cpu_gpu_device_builtin T)
#	define uX_gen_cpu_gpu_device_builtin_S_finline(T) uX_S_finline(uX_gen_cpu_gpu_device_builtin T)
#	define uX_gen_cpu_gpu_device_builtin_inline(T) uX_inline uX_gen_cpu_gpu_device_builtin T
#	define uX_gen_cpu_gpu_device_builtin_finline(T) uX_finline(uX_gen_cpu_gpu_device_builtin T)

#	define uX_gen_cpu_gpu_S_inline(T) uX_S_inline(uX_gen_cpu_gpu T)
#	define uX_gen_cpu_gpu_S_finline(T) uX_S_finline(uX_gen_cpu_gpu T)
#	define uX_gen_cpu_gpu_inline uX_inline uX_gen_cpu_gpu
#	define uX_gen_cpu_gpu_finline(T) uX_finline(uX_gen_cpu_gpu T)

#	define uX_gen_cpu_gpu_device_builtin_S_inline_veccall(T) uX_S_inline(uX_gen_cpu_gpu_device_builtin T)
#	define uX_gen_cpu_gpu_device_builtin_S_finline_veccall(T) uX_S_finline(uX_gen_cpu_gpu_device_builtin T)
#	define uX_gen_cpu_gpu_device_builtin_inline_veccall(T) uX_inline uX_gen_cpu_gpu_device_builtin T
#	define uX_gen_cpu_GP_device_builtinU_finline_veccall(T) uX_finline(uX_gen_cpu_gpu_device_builtin T)

#	define uX_gen_cpu_gpu_S_inline_veccall(T) uX_S_inline(uX_gen_cpu_gpu T)
#	define uX_gen_cpu_gpu_S_finline_veccall(T) uX_S_finline(uX_gen_cpu_gpu T)
#	define uX_gen_cpu_gpu_inline_veccall(T) uX_inline uX_gen_cpu_gpu T
#	define uX_gen_cpu_gpu_finline_veccall(T) uX_finline(uX_gen_cpu_gpu T)
#else
# if defined(uX_INTRINSICS_SUPPORT)

#	define uX_gen_cpu_only_S_inline_veccall(T) uX_S_inline_veccall(T)
#	define uX_gen_cpu_only_S_finline_veccall(T) uX_S_finline_veccall(T)
#	define uX_gen_cpu_only_inline_veccall(T) uX_inline_veccall(T)
#	define uX_gen_cpu_only_finline_veccall(T) uX_finline_veccall(T)

#	define uX_gen_cpu_gpu_device_builtin_S_inline_veccall(T) uX_S_inline_veccall(T)
#	define uX_gen_cpu_gpu_device_builtin_S_finline_veccall(T) uX_S_finline_veccall(T)
#	define uX_gen_cpu_gpu_device_builtin_inline_veccall(T) uX_inline_veccall(T)
#	define uX_gen_cpu_GP_device_builtinU_finline_veccall(T) uX_finline_veccall(T)

#	define uX_gen_cpu_gpu_S_inline_veccall(T) uX_S_inline_veccall(T)
#	define uX_gen_cpu_gpu_S_finline_veccall(T) uX_S_finline_veccall(T)
#	define uX_gen_cpu_gpu_inline_veccall(T) uX_inline_veccall(T)
#	define uX_gen_cpu_gpu_finline_veccall(T) uX_finline_veccall(T)
# else

#	define uX_gen_cpu_only_S_inline_veccall(T) uX_S_inline(T)
#	define uX_gen_cpu_only_S_finline_veccall(T) uX_S_finline(T)
#	define uX_gen_cpu_only_inline_veccall(T) uX_inline T
#	define uX_gen_cpu_only_finline_veccall(T) uX_finline(T)

#	define uX_gen_cpu_gpu_device_builtin_S_inline_veccall(T) uX_S_inline(T)
#	define uX_gen_cpu_gpu_device_builtin_S_finline_veccall(T) uX_S_finline(T)
#	define uX_gen_cpu_gpu_device_builtin_inline_veccall(T) uX_inline T
#	define uX_gen_cpu_GP_device_builtinU_finline_veccall(T) uX_finline(T)

#	define uX_gen_cpu_gpu_S_inline_veccall(T) uX_S_inline(T)
#	define uX_gen_cpu_gpu_S_finline_veccall(T) uX_S_finline(T)
#	define uX_gen_cpu_gpu_inline_veccall(T) uX_inline T
#	define uX_gen_cpu_gpu_finline_veccall(T) uX_finline(T)
# endif

#	define uX_gen_gpu_only_device_builtin_S_inline(T) uX_S_inline(T)
#	define uX_gen_gpu_only_device_builtin_S_finline(T) uX_S_finline( T)
#	define uX_gen_gpu_only_device_builtin_inline(T) uX_inline T
#	define uX_gen_gpu_only_device_builtin_finline(T) uX_finline(T)

#	define uX_gen_gpu_only_S_inline(T) uX_S_inline(T)
#	define uX_gen_gpu_only_S_finline(T) uX_S_finline(T)
#	define uX_gen_gpu_only_inline(T) uX_inline T
#	define uX_gen_gpu_only_finline(T) uX_finline(T)

#	define uX_gen_cpu_only_S_inline(T) uX_S_inline(T)
#	define uX_gen_cpu_only_S_finline(T) uX_S_finline(T)
#	define uX_gen_cpu_only_inline(T) uX_inline T
#	define uX_gen_cpu_only_finline(T) uX_finline(T)

#	define uX_gen_cpu_gpu_device_builtin_S_inline(T) uX_S_inline(T)
#	define uX_gen_cpu_gpu_device_builtin_S_finline(T) uX_S_finline(T)
#	define uX_gen_cpu_gpu_device_builtin_inline(T) uX_inline T
#	define uX_gen_cpu_gpu_device_builtin_finline(T) uX_finline(T)

#	define uX_gen_cpu_gpu_S_inline(T) uX_S_inline(T)
#	define uX_gen_cpu_gpu_S_finline(T) uX_S_finline(T)
#	define uX_gen_cpu_gpu_inline uX_inline
#	define uX_gen_cpu_gpu_finline(T) uX_finline(T)
#endif

#if defined(BUILD_AMP)
#define uX_BUILD_AMP_SUPPORT 1
#endif

#if defined(BUILD_CUDA)
#define uX_BUILD_CUDA_SUPPORT 1
#endif

#if defined(BUILD_OPENCL)
#define uX_BUILD_OPENCL_SUPPORT 1
#endif

#if defined(BUILD_SYCL)
#define uX_BUILD_SYCL_SUPPORT 1
#endif

#if defined(BUILD_HLSL)
#define uX_BUILD_HLSL_SUPPORT 1
#endif

#if defined(BUILD_ROCM)
#define uX_BUILD_ROCM_SUPPORT 1
#endif

#if defined(uX_BUILD_AMP_SUPPORT) || defined(uX_BUILD_CUDA_SUPPORT) || defined(uX_BUILD_OPENCL_SUPPORT) || defined(uX_BUILD_SYCL_SUPPORT) || defined(uX_BUILD_HLSL_SUPPORT) || defined(uX_BUILD_ROCM_SUPPORT)
#define uX_BUILD_GPU_SUPPORT
#endif

#if defined(uX_X86_OR_X64_ABI) && (defined(uX_MSVC_COMPATIBLE_COMPILER)) && !defined(uX_BUILD_GPU_SUPPORT)
#	define uX_abi uX_callconv
//#	define uX_abi
#elif defined(uX_X86_OR_X64_ABI) && (defined(uX_GCC_COMPATIBLE_COMPILER)) && !defined(uX_BUILD_GPU_SUPPORT)
#	define uX_abi uX_callconv
#else
#	define uX_abi
#endif

#if defined(uX_BUILD_AMP_SUPPORT)
//#include <amp.h>
#	define uX_cpu_amp		restrict(cpu,amp)
...
#	if defined(uX_CC_PDEF_GPU_SUPPORT)
// static inline
#	define uX_gen_gpu_only_device_builtin_CGLOBALAPI(T) uX_CGLOBAL_API(uX_gen_gpu_only uX_gen_device_builtin T)
// inline only
#	define __uX_gen_gpu_only_device_builtin_CGLOBALAPI(T) __uX_CGLOBAL_API(uX_gen_gpu_only uX_gen_device_builtin T)
// static inline
#	define uX_gen_gpu_only_device_builtin_CCGLOBALAPI(T) uX_CCGLOBAL_API(uX_gen_gpu_only uX_gen_device_builtin T)
// inline only
#	define __uX_gen_gpu_only_device_builtin_CCGLOBALAPI(T) __uX_CCGLOBAL_API(uX_gen_gpu_only uX_gen_device_builtin T)

// static inline
#	define uX_gen_gpu_only_CGLOBALAPI(T) uX_CGLOBAL_API(uX_gen_gpu_only T)
// inline only
#	define __uX_gen_gpu_only_CGLOBALAPI(T) __uX_CGLOBAL_API(uX_gen_gpu_only T)
// static inline
#	define uX_gen_gpu_only_CCGLOBALAPI(T) uX_CCGLOBAL_API(uX_gen_gpu_only T)
// inline only
#	define __uX_gen_gpu_only_CCGLOBALAPI(T) __uX_CCGLOBAL_API(uX_gen_gpu_only T)

// static inline
#	define uX_gen_cpu_gpu_device_builtin_CGLOBALAPI(T) uX_CGLOBAL_API(uX_gen_cpu_gpu uX_gen_device_builtin T)
// inline only
#	define __uX_gen_cpu_gpu_device_builtin_CGLOBALAPI(T) __uX_CGLOBAL_API(uX_gen_cpu_gpu uX_gen_device_builtin T)
// static inline
#	define uX_gen_cpu_gpu_device_builtin_CCGLOBALAPI(T) uX_CCGLOBAL_API(uX_gen_cpu_gpu uX_gen_device_builtin T)
// inline only
#	define __uX_gen_cpu_gpu_device_builtin_CCGLOBALAPI(T) __uX_CCGLOBAL_API(uX_gen_cpu_gpu uX_gen_device_builtin T)

// static inline
#	define uX_gen_cpu_gpu_CGLOBALAPI(T) uX_CGLOBAL_API(uX_gen_cpu_gpu T)
// inline only
#	define __uX_gen_cpu_gpu_CGLOBALAPI(T) __uX_CGLOBAL_API(uX_gen_cpu_gpu T)
// static inline
#	define uX_gen_cpu_gpu_CCGLOBALAPI(T) uX_CCGLOBAL_API(uX_gen_cpu_gpu T)
// inline only
#	define __uX_gen_cpu_gpu_CCGLOBALAPI(T) __uX_CCGLOBAL_API(uX_gen_cpu_gpu T)

// static inline
#	define uX_gen_cpu_only_CGLOBALAPI(T) uX_CGLOBAL_API(uX_gen_cpu_only T)
// inline only
#	define __uX_gen_cpu_only_CGLOBALAPI(T) __uX_CGLOBAL_API(uX_gen_cpu_only T)
// static inline
#	define uX_gen_cpu_only_CCGLOBALAPI(T) uX_CCGLOBAL_API(uX_gen_cpu_only T)
// inline only
#	define __uX_gen_cpu_only_CCGLOBALAPI(T) __uX_CCGLOBAL_API(uX_gen_cpu_only T)
#	else

// static inline
#	define uX_gen_gpu_only_device_builtin_CGLOBALAPI(T) uX_CGLOBAL_API(T)
// inline only
#	define __uX_gen_gpu_only_device_builtin_CGLOBALAPI(T) __uX_CGLOBAL_API(T)
// static inline
#	define uX_gen_gpu_only_device_builtin_CCGLOBALAPI(T) uX_CCGLOBAL_API(T)
// inline only
#	define __uX_gen_gpu_only_device_builtin_CCGLOBALAPI(T) __uX_CCGLOBAL_API(T)

// static inline
#	define uX_gen_gpu_only_CGLOBALAPI(T) uX_CGLOBAL_API(T)
// inline only
#	define __uX_gen_gpu_only_CGLOBALAPI(T) __uX_CGLOBAL_API(T)
// static inline
#	define uX_gen_gpu_only_CCGLOBALAPI(T) uX_CCGLOBAL_API(T)
// inline only
#	define __uX_gen_gpu_only_CCGLOBALAPI(T) __uX_CCGLOBAL_API(T)

// static inline
#	define uX_gen_cpu_gpu_device_builtin_CGLOBALAPI(T) uX_CGLOBAL_API(T)
// inline only
#	define __uX_gen_cpu_gpu_device_builtin_CGLOBALAPI(T) __uX_CGLOBAL_API(T)
// static inline
#	define uX_gen_cpu_gpu_device_builtin_CCGLOBALAPI(T) uX_CCGLOBAL_API(T)
// inline only
#	define __uX_gen_cpu_gpu_device_builtin_CCGLOBALAPI(T) __uX_CCGLOBAL_API(T)

// static inline
#	define uX_gen_cpu_gpu_CGLOBALAPI(T) uX_CGLOBAL_API(T)
// inline only
#	define __uX_gen_cpu_gpu_CGLOBALAPI(T) __uX_CGLOBAL_API(T)
// static inline
#	define uX_gen_cpu_gpu_CCGLOBALAPI(T) uX_CCGLOBAL_API(T)
// inline only
#	define __uX_gen_cpu_gpu_CCGLOBALAPI(T) __uX_CCGLOBAL_API(T)

// static inline
#	define uX_gen_cpu_only_CGLOBALAPI(T) uX_CGLOBAL_API(T)
// inline only
#	define __uX_gen_cpu_only_CGLOBALAPI(T) __uX_CGLOBAL_API(T)
// static inline
#	define uX_gen_cpu_only_CCGLOBALAPI(T) uX_CCGLOBAL_API(T)
// inline only
#	define __uX_gen_cpu_only_CCGLOBALAPI(T) __uX_CCGLOBAL_API(T)
#	endif

# if defined(uX_BUILD_AMP_SUPPORT)
// static inline
#	define uX_gen_gpu_only_device_builtin_NMGLOBALAPI(T) uX_gen_gpu_only_device_builtin_CCGLOBALAPI(T)
// inline only
#	define __uX_gen_gpu_only_device_builtin_NMGLOBALAPI(T) __uX_gen_gpu_only_device_builtin_CCGLOBALAPI(T)
// static inline
#	define uX_gen_gpu_only_NMGLOBALAPI(T) uX_gen_gpu_only_CCGLOBALAPI(T)
// inline only
#	define __uX_gen_gpu_only_BUILTIN_NMGLOBALAPI(T) __uX_gen_gpu_only_CCGLOBALAPI(T)
// static inline
#	define uX_gen_cpu_gpu_device_builtin_NMGLOBALAPI(T) uX_gen_cpu_gpu_device_builtin_CCGLOBALAPI(T)
// inline only
#	define __uX_gen_cpu_gpu_device_builtin_NMGLOBALAPI(T) __uX_gen_cpu_gpu_device_builtin_CCGLOBALAPI(T)
// static inline
#	define uX_gen_cpu_gpu_NMGLOBALAPI(T) uX_gen_cpu_gpu_CCGLOBALAPI(T)
// inline only
#	define __uX_gen_cpu_gpu_NMGLOBALAPI(T) __uX_gen_cpu_gpu_CCGLOBALAPI(T)
// static inline
#	define uX_gen_cpu_only_NMGLOBALAPI(T) uX_gen_cpu_only_CCGLOBALAPI(T)
// inline only
#	define __uX_gen_cpu_only_BUILTIN_NMGLOBALAPI(T) __uX_gen_cpu_only_CCGLOBALAPI(T)
# else
// static inline
#	define uX_gen_gpu_only_device_builtin_NMGLOBALAPI(T) uX_gen_gpu_only_device_builtin_CGLOBALAPI(T)
// inline only
#	define __uX_gen_gpu_only_device_builtin_NMGLOBALAPI(T) __uX_gen_gpu_only_device_builtin_CGLOBALAPI(T)
// static inline
#	define uX_gen_gpu_only_NMGLOBALAPI(T) uX_gen_gpu_only_CGLOBALAPI(T)
// inline only
#	define __uX_gen_gpu_only_BUILTIN_NMGLOBALAPI(T) __uX_gen_gpu_only_CGLOBALAPI(T)
// static inline
#	define uX_gen_cpu_gpu_device_builtin_NMGLOBALAPI(T) uX_gen_cpu_gpu_device_builtin_CGLOBALAPI(T)
// inline only
#	define __uX_gen_cpu_gpu_device_builtin_NMGLOBALAPI(T) __uX_gen_cpu_gpu_device_builtin_CGLOBALAPI(T)
// static inline
#	define uX_gen_cpu_gpu_NMGLOBALAPI(T) uX_gen_cpu_gpu_CGLOBALAPI(T)
// inline only
#	define __uX_gen_cpu_gpu_NMGLOBALAPI(T) __uX_gen_cpu_gpu_CGLOBALAPI(T)
// static inline
#	define uX_gen_cpu_only_NMGLOBALAPI(T) uX_gen_cpu_only_CGLOBALAPI(T)
// inline only
#	define __uX_gen_cpu_only_NMGLOBALAPI(T) __uX_gen_cpu_only_CGLOBALAPI(T)
# endif
...
#	define uX_UNREACHABLE __builtin_unreachable()
#elif defined(uX_MSVC_COMPILER)
#	define uX_UNREACHABLE __assume(0)
#else
#	define uX_UNREACHABLE
#endif
...
*/
#if defined(uX_NOEXCEPT_SUPPORT) && !defined(uX_BUILD_AMP_SUPPORT)
...
template <class T>
uX_gen_cpu_gpu_inline void uX_UNREFPAR_UNUSED(T const&) uX_cpu_amp {}
...
# if defined(uX_AMP_USE_PRECISE_PRECISION)
#	define ampmath(Name) __dp_math_##Name
# elif defined(uX_BUILD_AMP_SUPPORT) && defined(uX_AMP_USE_FAST_PRECISION)
...
#	define namespace_gpu namespace gpu {
#	define namespace_gpu_end }
#	define namespace_x86 namespace x86 {
#	define namespace_x86_end }
#	define namespace_arm namespace arm {
#	define namespace_arm_end }
#	define namespace_arm64 namespace arm64 {
#	define namespace_arm64_end }
#	define namespace_detail namespace detail {
#	define namespace_detail_end }
#	define namespace_amp namespace amp {
#	define namespace_amp_end }
#	define namespace_cuda namespace cuda {
#	define namespace_cuda_end }
#	define namespace_cl namespace cl {
#	define namespace_cl_end }
#	define namespace_sycl namespace sycl {
#	define namespace_sycl_end }
...
#	define namespace_sse namespace xmm {
#	define namespace_sse_end }
#	define namespace_avx namespace ymm {
#	define namespace_avx_end }
#	define namespace_avx512 namespace zmm {
#	define namespace_avx512_end }
#else
#if defined(uX_DIRECTXMATH_SUPPORT)
#	define namespace_DirectX
#	define namespace_DirectX_end
#endif
#	define namespace_uX
#	define namespace_uX_end
#	define namespace_cpu
#	define namespace_cpu_end
#	define namespace_gpu
#	define namespace_gpu_end
#	define namespace_x86
#	define namespace_x86_end
#	define namespace_arm
#	define namespace_arm_end
#	define namespace_arm64
#	define namespace_arm64_end
#	define namespace_detail
#	define namespace_detail_end
#	define namespace_amp
#	define namespace_amp_end
#	define namespace_cuda
#	define namespace_cuda_end
#	define namespace_cl
#	define namespace_cl_end
#	define namespace_sycl
#	define namespace_sycl_end
#	define namespace_std
#	define namespace_std_end
#	define namespace_xmm
#	define namespace_xmm_end
#	define namespace_ymm
#	define namespace_ymm_end
#	define namespace_zmm
#	define namespace_zmm_end
#	define namespace_sse
#	define namespace_sse_end
#	define namespace_avx
#	define namespace_avx_end
#	define namespace_avx512
#	define namespace_avx512_end
#endif
...
namespace sse = xmm;
namespace avx = ymm;
namespace avx512 = zmm;
namespace_sse
namespace_sse_end
namespace_avx
namespace_avx_end
namespace_avx512
namespace_avx512_end
#endif
#endif /* __cplusplus */
