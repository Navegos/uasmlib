...
uX_PACK_PUSH_XMM
    ...
    extern __m128i uX_callconv _uX_mm_select_si128(__m128i Inxmm_S, __m128i Inxmm_A, __m128i Inxmm_B);
    extern __m128 uX_callconv _uX_mm_select_ps(__m128 Inxmm_S, __m128 Inxmm_A, __m128 Inxmm_B);
    extern __m128d uX_callconv _uX_mm_select_pd(__m128d Inxmm_S, __m128d Inxmm_A, __m128d Inxmm_B);
    ...
    extern __m128i uX_callconv _uX_mm_mule_epi8(__m128i Inxmm_A, __m128i Inxmm_B);

    // Packed integer 16-bit multiplication of 8 16-bit of elements

    extern __m128i uX_callconv _uX_mm_mule_epi16(__m128i Inxmm_A, __m128i Inxmm_B);

    // Packed integer 32-bit multiplication of 4 32-bit of elements

    extern __m128i uX_callconv _uX_mm_mule_epi32(__m128i Inxmm_A, __m128i Inxmm_B);

    // Packed integer 64-bit multiplication of 2 64-bit of elements

    extern __m128i uX_callconv _uX_mm_mule_epi64(__m128i Inxmm_A, __m128i Inxmm_B);
    ...
    extern __m128 uX_callconv _uX_mm_insert_ps(__m128 dst, __m128 src, const unsigned int index);
