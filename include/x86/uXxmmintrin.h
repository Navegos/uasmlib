 ...
 */
    ...
    extern __m128 uX_callconv _uX_mm_negate_ps(__m128 Inxmm_A);

    extern __m128 uX_callconv _uX_mm_and_ss(__m128 Inxmm_A, __m128 Inxmm_B);
    extern __m128 uX_callconv _uX_mm_andnot_ss(__m128 Inxmm_A, __m128 Inxmm_B);
    extern __m128 uX_callconv _uX_mm_or_ss(__m128 Inxmm_A, __m128 Inxmm_B);
    extern __m128 uX_callconv _uX_mm_xor_ss(__m128 Inxmm_A, __m128 Inxmm_B);
    extern __m128 uX_callconv _uX_mm_not_ss(__m128 Inxmm_A);
    extern __m128 uX_callconv _uX_mm_negate_ss(__m128 Inxmm_A);

    extern unsigned int uX_callconv _uX_mm_iand_ps(__m128 Inxmm_A, __m128 Inxmm_B);
    extern unsigned int uX_callconv _uX_mm_iandnot_ps(__m128 Inxmm_A, __m128 Inxmm_B);
    extern unsigned int uX_callconv _uX_mm_ior_ps(__m128 Inxmm_A, __m128 Inxmm_B);
    extern unsigned int uX_callconv _uX_mm_inot_ps(__m128 Inxmm_A);

    extern unsigned int uX_callconv _uX_mm_iand_ss(__m128 Inxmm_A, __m128 Inxmm_B);
    extern unsigned int uX_callconv _uX_mm_iandnot_ss(__m128 Inxmm_A, __m128 Inxmm_B);
    extern unsigned int uX_callconv _uX_mm_ior_ss(__m128 Inxmm_A, __m128 Inxmm_B);
    extern unsigned int uX_callconv _uX_mm_inot_ss(__m128 Inxmm_A);

    extern unsigned int uX_callconv _uX_mm_ihand_ps(__m128 Inxmm_A);
    extern unsigned int uX_callconv _uX_mm_ihor_ps(__m128 Inxmm_A);
 ...
 */
    ...
    extern float uX_callconv _uX_mm_cvtss_flt(__m128 Inxmm_A);
    extern float uX_callconv _uX_mm_cvtps_flt(__m128 Inxmm_A, const unsigned int InInt_BSel);

    extern __m128 uX_callconv _uX_mm_cvtflt_ps(__m128 Inxmm_A, float Infloat_B, const unsigned int InInt_CSel);
 ...
 */
    ...
    extern unsigned int uX_callconv _uX_mm_iszero_ps(__m128 Inxmm_A);
