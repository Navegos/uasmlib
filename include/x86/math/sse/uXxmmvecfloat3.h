...
public:
     ...
     */
    uX_constexpr vecfloat3(const __m128 Inxmm) uX_noexcept : m128_xmm(_uX_MM_SHUFFLER_IM_PS(Inxmm, _uX_MM_SHUFFLER_IM_PS(Inxmm, __m128_false, 2, 1, 3, 3), 0, 1, 0, 3)) {}
     ...
     */
    uX_constexpr vecfloat3(const vecfloat4 Inxmm_a) uX_noexcept : m128_xmm(_uX_MM_SHUFFLER_IM_PS(Inxmm_a, _uX_MM_SHUFFLER_IM_PS(Inxmm_a, __m128_false, 2, 1, 3, 3), 0, 1, 0, 3)) {}
     ...
     */
    uX_constexpr vecfloat3(vecdouble3 const InHxmmd_a) uX_noexcept : m128_xmm(_uX_MM_SHUFFLER_IM_PS(_uX_mm_cvtpd_ps(InHxmmd_a.get_xmmd_0()), _uX_mm_cvtpd_ps(InHxmmd_a.get_xmmd_1()), 0, 1, 2, 3)) {}
    ...
    {
        return vecfloat2(_uX_MM_PERMUTER_IM_PS(m128_xmm, 1, 2, 2, 3));
    }
    ...
    {
        return vecfloat3(_uX_MM_PERMUTER_IM_PS(m128_xmm, 1, 2, 0, 3));
    }
    ...
    {
        return vecfloat2(_uX_MM_PERMUTER_IM_PS(m128_xmm, 2, 0, 2, 3));
    }
    ...
    {
        return vecfloat3(_uX_MM_PERMUTER_IM_PS(m128_xmm, 2, 0, 1, 3));
    }
    ...
    {
        return vecfloat2(_uX_MM_PERMUTER_IM_PS(m128_xmm, 2, 1, 2, 3));
    }
    ...
    {
        return vecfloat3(_uX_MM_PERMUTER_IM_PS(m128_xmm, 2, 1, 0, 3));
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 0, 1, 2, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(Inxmm_a, _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 2, 2, 3, 3), 0, 1, 0, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(_uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 0, 0, 1, 1), _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 1, 1, 3, 3), 0, 2, 0, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(Inxmm_a, _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 1, 1, 3, 3), 0, 2, 1, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SETFLT_IM_PS(m128_xmm, Infloat_a, 1);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(Inxmm_a, _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 2, 2, 3, 3), 1, 0, 0, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(_uX_MM_SHUFFLER_IM_PS(m128_xmm, Inxmm_a, 0, 0, 0, 0), _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 1, 1, 3, 3), 0, 2, 0, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(Inxmm_a, _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 0, 1, 2, 3), 2, 0, 1, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SETFLT_IM_PS(m128_xmm, Infloat_a, 2);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(_uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 1, 1, 1, 1), _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 0, 0, 3, 3), 0, 2, 0, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(Inxmm_a, _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 0, 0, 3, 3), 1, 2, 0, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(_uX_MM_SHUFFLER_IM_PS(m128_xmm, Inxmm_a, 0, 0, 1, 1), _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 0, 0, 3, 3), 0, 1, 0, 3);
    }
    ...
    {
        m128_xmm = _uX_MM_SHUFFLER_IM_PS(Inxmm_a, _uX_MM_SHUFFLER_IM_PS(Inxmm_a, m128_xmm, 0, 0, 3, 3), 2, 1, 0, 3);
    }
    ...
    uX_constexpr vecfloat3& uX_ABI cutoff(count_t indexN) uX_noexcept
    {
        ...
        {
            case 2:
                m128_xmm = _uX_MM_SHUFFLER_IM_PS(m128_xmm, __m128_0, 0, 1, 2, 3);
                break;
            case 1:
...
public:
     ...
     */
    uX_constexpr count_t const uX_ABI flt_ptr_lenght(void) const uX_noexcept
    {
        return 3;
    }
