...
public:
     ...
     */
    uX_explicit vecfloat4x3(const __m128* Inpxmm, uint32_t idxbegin = 0, uint32_t idxend = m128_xmm_ptr_lenght) uX_noexcept;
     ...
     */
    uX_explicit vecfloat4x3(const float* Inpfloat, uint32_t idxbegin = 0, uint32_t idxend = m128_xmm_ptr_lenght) uX_noexcept;
