...
/** \class vecqword3
  *
  * \brief SSE SIMD class with the size of 3 int64_t elements.
  *
  * The %vecqword3 class is an 3 elements wide 32bit integer.
...
public:
    ...
    vecqword3(const vecqword3&)uX_default;
    vecqword3& uX_ABI operator=(const vecqword3&)uX_default;

    vecqword3(vecqword3&&)uX_default;
    vecqword3& uX_ABI operator=(vecqword3&&)uX_default;
     ...
     */
    uX_constexpr vecqword3(const __m128i Inxmmi_a) uX_noexcept : m128_xmmi_0(Inxmmi_a) {}
     ...
     */
    uX_constexpr vecqword3(const __m128i Inxmmi_0, const __m128i Inxmmi_1) uX_noexcept : m128_xmmi_0(Inxmmi_0), m128_xmmi_1(_uX_mm_select_si128(__m128i_i64_select10, Inxmmi_1, __m128i_i64_false)) {}
     ...
     */
    uX_constexpr vecqword3(const vecqword4 InHxmmi_a) uX_noexcept : m128_xmmi_0(InHxmmi_a.get_xmmi_0()), m128_xmmi_1(_uX_mm_select_si128(__m128i_i64_select10, InHxmmi_a.get_xmmi_1(), __m128i_i64_false)) {}
     ...
     * @param Inxmmi_a value to copy from.
     */
    uX_constexpr vecqword3(const vecqword2 Inxmmi_a) uX_noexcept : m128_xmmi_0(Inxmmi_a) {}
     ...
     * @param Inxmmi_a value to copy from.
     */
    uX_constexpr vecqword3(const vecqword1 Inxmmi_a) uX_noexcept : m128_xmmi_0(_uX_mm_select_si128(__m128i_i64_select10, Inxmmi_a, m128_xmmi_0)) {}
     ...
     * @param InHxmmi_a value to copy from.
     */
    uX_constexpr vecqword3(const vecuqword3 InHxmmi_a) uX_noexcept : m128_xmmi_0(InHxmmi_a.get_xmmi_0()), m128_xmmi_1(InHxmmi_a.get_xmmi_1()) {}
     ...
     */
    uX_constexpr vecqword3(const vecdouble3 InxHmmd_a) uX_noexcept : m128_xmmi_0(_uX_mm_castpd_si128(InxHmmd_a.get_xmmd_0())), m128_xmmi_1(_uX_mm_castpd_si128(InxHmmd_a.get_xmmd_1())) {}
     ...
     */
    uX_explicit uX_constexpr vecqword3(const int64_t Inint_a) uX_noexcept : m128_xmmi_0(_uX_mm_setr_epi64x(Inint_a, Inint_a)), m128_xmmi_1(_uX_mm_setr_epi64x(Inint_a, 0)) {}

    /**
     * \brief Constructor initialization from 3 type int64_t.
     *
     * \param Inint_X value to copy from.
     * \param Inint_Y value to copy from.
     * \param Inint_Z value to copy from.
     */
    uX_constexpr vecqword3(const int64_t Inint_X, const int64_t Inint_Y, const int64_t Inint_Z) uX_noexcept : m128_xmmi_0(_uX_mm_setr_epi64x(Inint_X, Inint_Y)), m128_xmmi_1(_uX_mm_setr_epi64x(Inint_Z, 0)) {}
     ...
     */
    uX_explicit uX_constexpr vecqword3(const bool_t Inbool_a) uX_noexcept : m128_xmmi_0(_uX_mm_set1_epi64x(Inbool_a.to_trueint())), m128_xmmi_1(_uX_mm_setr_epi64x(Inbool_a.to_trueint(), 0)) {}
     ...
     */
    uX_constexpr vecqword3(const bool_t Inbool_X, const bool_t Inbool_Y, const bool_t Inbool_Z) uX_noexcept
     ...
     * \param Inbool_a value to copy from.
     */
    uX_explicit uX_constexpr vecqword3(const bool Inbool_a) uX_noexcept : m128_xmmi_0(vecqword2(bool_t(Inbool_a))), m128_xmmi_1(_uX_mm_setr_epi64x(bool_t(Inbool_a).to_trueint(), 0)) {}
     ...
     * \param Inbool_Z value to copy from.
     */
    uX_constexpr vecqword3(const bool Inbool_X, const bool Inbool_Y, const bool Inbool_Z) uX_noexcept : m128_xmmi_0(vecqword2(bool_t(Inbool_X), bool_t(Inbool_Y))), m128_xmmi_1(_uX_mm_setr_epi64x(bool_t(Inbool_Z).to_trueint(), 0)) {}
     ...
     */
    uX_explicit uX_constexpr vecqword3(uX_InReads(3) const int64_t* Inpint32) uX_noexcept : m128_xmmi_0(_uX_mm_setr_epi64x(Inpint32[0], Inpint32[1])), m128_xmmi_1(_uX_mm_setr_epi64x(Inpint32[2], 0)) {}
     ...
     */
    vecqword3& uX_ABI operator=(const __m128i Inxmmi) uX_noexcept;
     ...
     * \param InHxmmi_a value to copy from.
     */
    vecqword3& uX_ABI operator=(const vecqword4 InHxmmi_a) uX_noexcept;
     ...
     * \param Inxmmi_a value to copy from.
     */
    vecqword3& uX_ABI operator=(const vecqword2 Inxmmi_a) uX_noexcept;
     ...
     * \param Inxmmi_a value to copy from.
     */
    vecqword3& uX_ABI operator=(const vecqword1 Inxmmi_a) uX_noexcept;
     ...
     * \param InHxmmi_a value to copy from.
     */
    vecqword3& uX_ABI operator=(const vecuqword3 InHxmmi_a) uX_noexcept;
     ...
     */
    vecqword3& uX_ABI operator=(const vecdouble3 InHxmm_a) uX_noexcept;
     ...
     * \param Inint_a int64_t value to copy from.
     */
    vecqword3& uX_ABI operator=(const int64_t Inint_a) uX_noexcept;
     ...
     * \param Inbool_a value to copy from.
     */
    vecqword3& uX_ABI operator=(const bool_t Inbool_a) uX_noexcept;
     ...
     * \param Inbool_a value to copy from.
     */
    vecqword3& uX_ABI operator=(const bool Inbool_a) uX_noexcept;
     ...
     * @param Inpint32 value to copy from.
     */
     /*vecqword3& uX_ABI operator=(uX_InReads(3) const int64_t* Inpint32);*/ //security undesired
     ...
     * \return vector.
     */
    vecqword3 uX_ABI get() const uX_noexcept;
     ...
     * \return vector.
     */
    vecqword3& uX_ABI ref() uX_noexcept;
     ...
     * \param InHxmmi.
     */
    vecqword3 uX_ABI set(const vecqword3 InHxmmi) uX_noexcept;


    vecqword2 uX_ABI get_xy() const uX_noexcept;

    int64_t uX_ABI get_z() const uX_noexcept;
    ...
    friend uX_constexpr vecqword3 uX_ABI constant3i64() {
