...
public:
     ...
     */
    uX_constexpr vecfloat2(__m128 const Inxmm) uX_noexcept : m128_xmm(_uX_MM_SHUFFLER_IM_PS(Inxmm, __m128_false, 0, 1, 2, 3)) {}
     ...
     */
    uX_constexpr vecfloat2(vecfloat4 const Inxmm_a) uX_noexcept : m128_xmm(_uX_MM_SHUFFLER_IM_PS(Inxmm_a, __m128_false, 0, 1, 2, 3)) {}
     ...
     * \Note Sets the _x _y float elements
     */
    uX_constexpr vecfloat2(vecfloat3 const Inxmm_a) uX_noexcept : m128_xmm(_uX_MM_SHUFFLER_IM_PS(Inxmm_a, __m128_false, 0, 1, 2, 3)) {}
