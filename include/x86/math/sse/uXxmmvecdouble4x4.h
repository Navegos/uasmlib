...
public:
     ...
     */
    uX_explicit vecdouble4x4(const __m128d* Inpxmmd, uint32_t idxbegin = 0, uint32_t idxend = m128_xmmd_ptr_lenght) uX_noexcept;
     ...
     */
    uX_explicit vecdouble4x4(const double* Inpdouble, uint32_t idxbegin = 0, uint32_t idxend = m128_xmmd_ptr_lenght) uX_noexcept;
