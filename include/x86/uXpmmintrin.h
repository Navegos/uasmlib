 ...
 */
    ...
    extern __m128d uX_ABI _uX_mm_loaddup_pd(const double* InPdouble_B);
    extern __m128d uX_ABI _uX_mm_movedup_pd(__m128d Inxmm_A);

/*
 * New unaligned integer vector load instruction.
 */
    extern __m128i uX_ABI _uX_mm_lddqu_si128(const __m128i* InPxmm_A);
 ...
 */
    extern void uX_ABI _uX_mm_monitor(const void* InPvoid_A, unsigned Ext_B, unsigned Hints_C);

/*
 * For _uX_mm_mwait, extensions goes in ecx, hints goes in eax.
 */
    extern void uX_ABI _uX_mm_mwait(unsigned Ext_A, unsigned Hints_C);
