...
#  endif
/*
# elif defined(uX_ICREGCALL)
#		define uX_callconv(T) __regcall T*/
# else
#	if defined(uX_X86_OR_X64_CPU) && !defined(uX_MIC)
#		define uX_callconv __fastcall
#	else
...
/*
# elif defined(uX_ICREGCALL)
#		define uX_veccall(T) __regcall T*/
# else
#	if defined(uX_X86_OR_X64_CPU) && !defined(uX_MIC)
#		define uX_veccall __fastcall
#	else
...
#	define uX_PACK_PUSH1				__pragma( pack(push, 1) )
#	define uX_PACK_PUSH2				__pragma( pack(push, 2) )
#	define uX_PACK_PUSH4				__pragma( pack(push, 4) )
#	define uX_PACK_PUSH8				__pragma( pack(push, 8) )
#	define uX_PACK_PUSH16				__pragma( pack(push, 16) )
#	define uX_PACK_DEF(X)			__pragma( pack(X) )
#	define uX_PACK1				__pragma( pack(1) )
#	define uX_PACK2				__pragma( pack(2) )
#	define uX_PACK4				__pragma( pack(4) )
#	define uX_PACK8				__pragma( pack(8) )
#	define uX_PACK16				__pragma( pack(16) )
# if (defined(_MSC_VER) && (_MSC_VER >= 1600)) || (defined(_MSC_VER) && (__INTEL_COMPILER >= 1300))
#	define uX_PACK_PUSH32				__pragma( pack(push, 32) )
#	define uX_PACK_PUSH64				__pragma( pack(push, 64) )
#	define uX_PACK_PUSH128				__pragma( pack(push, 128) )
#	define uX_PACK_PUSH256				__pragma( pack(push, 256) )
#	define uX_PACK_PUSH512				__pragma( pack(push, 512) )
#	define uX_PACK32				__pragma( pack(32) )
#	define uX_PACK64				__pragma( pack(64) )
#	define uX_PACK128				__pragma( pack(128) )
#	define uX_PACK256				__pragma( pack(256) )
#	define uX_PACK512				__pragma( pack(512) )
#else
#	define uX_PACK_PUSH32				__pragma( pack(push, 16) )
#	define uX_PACK_PUSH64				__pragma( pack(push, 16) )
#	define uX_PACK_PUSH128				__pragma( pack(push, 16) )
#	define uX_PACK_PUSH256				__pragma( pack(push, 16) )
#	define uX_PACK_PUSH512				__pragma( pack(push, 16) )
#	define uX_PACK32				__pragma( pack(16) )
#	define uX_PACK64				__pragma( pack(16) )
#	define uX_PACK128				__pragma( pack(16) )
#	define uX_PACK256				__pragma( pack(16) )
#	define uX_PACK512				__pragma( pack(16) )
# endif
#	define uX_PACK_PUSH_SIZET			__pragma( pack(push, uX_SIZE_T_SIZE) )
#	define uX_PACK_PUSH_POINTER		__pragma( pack(push, uX_POINTER_SIZE) )
#	define uX_PACK_SIZET				__pragma( pack(uX_SIZE_T_SIZE) )
#	define uX_PACK_POINTER				__pragma( pack(uX_POINTER_SIZE) )
...
#	define uX_PACK_PUSH1				_Pragma("pack(push, 1)")
#	define uX_PACK_PUSH2				_Pragma("pack(push, 2)")
#	define uX_PACK_PUSH4				_Pragma("pack(push, 4)")
#	define uX_PACK_PUSH8				_Pragma("pack(push, 8)")
#	define uX_PACK_PUSH16				_Pragma("pack(push, 16)")
#	define uX_PACK_PUSH32				_Pragma("pack(push, 32)")
#	define uX_PACK_PUSH64				_Pragma("pack(push, 64)")
#	define uX_PACK_PUSH128				_Pragma("pack(push, 128)")
#	define uX_PACK_PUSH256				_Pragma("pack(push, 256)")
#	define uX_PACK_PUSH512				_Pragma("pack(push, 512)")
#	define uX_PACK_PUSH_SIZET			_Pragma("pack(push, uX_SIZE_T_SIZE)")
#	define uX_PACK_PUSH_POINTER			_Pragma("pack(push, uX_POINTER_SIZE)")
#	define uX_PACK_DEF(X)			_Pragma("pack(X)")
#	define uX_PACK1				_Pragma("pack(1)")
#	define uX_PACK2				_Pragma("pack(2)")
#	define uX_PACK4				_Pragma("pack(4)")
#	define uX_PACK8				_Pragma("pack(8)")
#	define uX_PACK16				_Pragma("pack(16)")
#	define uX_PACK32				_Pragma("pack(32)")
#	define uX_PACK64				_Pragma("pack(64)")
#	define uX_PACK128				_Pragma("pack(128)")
#	define uX_PACK256				_Pragma("pack(256)")
#	define uX_PACK512				_Pragma("pack(512)")
#	define uX_PACK_SIZET			_Pragma("pack(uX_SIZE_T_SIZE)")
#	define uX_PACK_POINTER			_Pragma("pack(uX_POINTER_SIZE)")
#	define uX_PACK_POP					_Pragma("pack(pop)")
#	define uX_PRAGMA_ONCE				_Pragma("once")
#	define uX_PRAGMA(exprs)				_Pragma(uXStringer(exprs))
...
#	define uX_PACK_PUSH1				_Pragma("pack(1)")
#	define uX_PACK_PUSH2				_Pragma("pack(2)")
#	define uX_PACK_PUSH4				_Pragma("pack(4)")
#	define uX_PACK_PUSH8				_Pragma("pack(8)")
#	define uX_PACK_PUSH16				_Pragma("pack(16)")
#	define uX_PACK_PUSH32				_Pragma("pack(32)")
#	define uX_PACK_PUSH64				_Pragma("pack(64)")
#	define uX_PACK_PUSH128				_Pragma("pack(128)")
#	define uX_PACK_PUSH256				_Pragma("pack(256)")
#	define uX_PACK_PUSH512				_Pragma("pack(512)")
#	define uX_PACK_PUSH_SIZET			_Pragma("pack(uX_SIZE_T_SIZE)")
#	define uX_PACK_PUSH_POINTER		_Pragma("pack(uX_POINTER_SIZE)")
#	define uX_PACK_DEF(X)			_Pragma("pack(X)")
#	define uX_PACK1				_Pragma("pack(1)")
#	define uX_PACK2				_Pragma("pack(2)")
#	define uX_PACK4				_Pragma("pack(4)")
...
#	define uX_PACK_PUSH1
#	define uX_PACK_PUSH2
#	define uX_PACK_PUSH4
#	define uX_PACK_PUSH8
#	define uX_PACK_PUSH16
#	define uX_PACK_PUSH32
#	define uX_PACK_PUSH64
#	define uX_PACK_PUSH128
#	define uX_PACK_PUSH256
#	define uX_PACK_PUSH512
#	define uX_PACK_PUSH_SIZET
#	define uX_PACK_PUSH_POINTER
...
#	define uX_PACK256
#	define uX_PACK512
#	define uX_PACK_SIZET
#	define uX_PACK_POINTER
#	define uX_PACK_POP
...
#	define uX_default_ctor =default;
#else
#	define uX_default_ctor {}
#endif
...
#	define uX_TARGET_CPU_GPU_DEVICE_BUILTIN_S_INLINE(T) uX_S_INLINE(uX_TARGET_CPU_GPU uX_TARGET_DEVICE_BUILTIN T)
#	define uX_TARGET_CPU_GPU_DEVICE_BUILTIN_S_FINLINE(T) uX_S_FINLINE(uX_TARGET_CPU_GPU uX_TARGET_DEVICE_BUILTIN T)
#	define uX_TARGET_CPU_GPU_DEVICE_BUILTIN_INLINE(T) uX_INLINE(uX_TARGET_CPU_GPU uX_TARGET_DEVICE_BUILTIN T)
#	define uX_TARGET_CPU_GPU_DEVICE_BUILTIN_FINLINE(T) uX_FINLINE(uX_TARGET_CPU_GPU uX_TARGET_DEVICE_BUILTIN T)
...
#	define uX_TARGET_CPU_GPU_DEVICE_BUILTIN_S_INLINE_VECCALL(T) uX_S_INLINE(uX_TARGET_CPU_GPU uX_TARGET_DEVICE_BUILTIN T)
#	define uX_TARGET_CPU_GPU_DEVICE_BUILTIN_S_FINLINE_VECCALL(T) uX_S_FINLINE(uX_TARGET_CPU_GPU uX_TARGET_DEVICE_BUILTIN T)
#	define uX_TARGET_CPU_GPU_DEVICE_BUILTIN_INLINE_VECCALL(T) uX_INLINE(uX_TARGET_CPU_GPU uX_TARGET_DEVICE_BUILTIN T)
#	define uX_TARGET_CPU_GP_DEVICE_BUILTINU_FINLINE_VECCALL(T) uX_FINLINE(uX_TARGET_CPU_GPU uX_TARGET_DEVICE_BUILTIN T)
...
#			define uX_PACK_PUSH uX_PACK_PUSH8
...
#           define uX_PACK_PUSH uX_PACK_PUSH16
...
#           define uX_PACK_PUSH uX_PACK_PUSH16
#else
#           define uX_PACK_PUSH uX_PACK_PUSH32
#endif
...
#           define uX_PACK_PUSH uX_PACK_PUSH16
#else
#           define uX_PACK_PUSH uX_PACK_PUSH64
#endif
...
#           define uX_PACK_PUSH uX_PACK_PUSH128
...
#		define uX_NMPACK_PUSH uX_PACK_PUSH
#		define uX_NMPACK_PUSH1 uX_PACK_PUSH1
#		define uX_NMPACK_PUSH2 uX_PACK_PUSH2
#		define uX_NMPACK_PUSH4 uX_PACK_PUSH4
#		define uX_NMPACK_PUSH8 uX_PACK_PUSH8
#		define uX_NMPACK_PUSH16 uX_PACK_PUSH16
#		define uX_NMPACK_PUSH32 uX_PACK_PUSH32
#		define uX_NMPACK_PUSH64 uX_PACK_PUSH64
