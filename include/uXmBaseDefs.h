...
# elif defined(uXm_GCC_COMPATIBLE_COMPILER)
#		define uXmGC_VEC_INTRINTYPE(X) __attribute__((aligned(X)))
#		define uXmGC_VEC_INTRINTYPE_ALIAS(X) __attribute__((aligned(X), __may_alias__))

#		define uXm_VEC_SIZE_INTRINTYPE(Type,Name,size) Type Name __attribute__((__vector_size__(size)))
#		define uXm_VEC_SIZE_INTRINTYPE_ALIAS(Type,Name,size) Type Name __attribute__((__vector_size__(size), __may_alias__))

#		define uXm_NEONVEC_SIZE_INTRINTYPE(Type,Name,size) Type Name __attribute__((neon_vector_type(size)))
#		define uXm_NEONVEC_SIZE_INTRINTYPE_ALIAS(Type,Name,size) Type Name __attribute__((neon_vector_type(size), __may_alias__))

#		define uXm_VEC_SIZE(Type,Name,size) Type Name[size] __attribute__((aligned(size)))
#		define uXm_VEC_SIZE_ALIAS(Type,Name,size) Type Name[size] __attribute__((aligned(size), __may_alias__))

#		define uXmGC_VEC_INTRINTYPE4 __attribute__((aligned(4)))
#		define uXmGC_VEC_INTRINTYPE8 __attribute__((aligned(8)))
#		define uXmGC_VEC_INTRINTYPE16 __attribute__((aligned(16)))
#		define uXmGC_VEC_INTRINTYPE32 __attribute__((aligned(32)))
#		define uXmGC_VEC_INTRINTYPE64 __attribute__((aligned(64)))
#		define uXmGC_VEC_INTRINTYPE128 __attribute__((aligned(128)))
#		define uXmGC_VEC_INTRINTYPE256 __attribute__((aligned(256)))
#		define uXmGC_VEC_INTRINTYPE512 __attribute__((aligned(512)))

#		define uXmGC_VEC_INTRINTYPE4_ALIAS __attribute__((aligned(4), __may_alias__))
#		define uXmGC_VEC_INTRINTYPE8_ALIAS __attribute__((aligned(8), __may_alias__))
#		define uXmGC_VEC_INTRINTYPE16_ALIAS __attribute__((aligned(16), __may_alias__))
#		define uXmGC_VEC_INTRINTYPE32_ALIAS __attribute__((aligned(32), __may_alias__))
#		define uXmGC_VEC_INTRINTYPE64_ALIAS __attribute__((aligned(64), __may_alias__))
#		define uXmGC_VEC_INTRINTYPE128_ALIAS __attribute__((aligned(128), __may_alias__))
#		define uXmGC_VEC_INTRINTYPE256_ALIAS __attribute__((aligned(256), __may_alias__))
#		define uXmGC_VEC_INTRINTYPE512_ALIAS __attribute__((aligned(512), __may_alias__))
